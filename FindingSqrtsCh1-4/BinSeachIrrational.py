...
#import decimal library for added precision
import math
from decimal import Decimal, getcontext

#set precision for 100 decimal places
getcontext().prec = 100

#This code block asks for an integer value of x_squared
#and it asks for number of iterations, n
...
upper_bound = Decimal(10 ** (power_for_10))
